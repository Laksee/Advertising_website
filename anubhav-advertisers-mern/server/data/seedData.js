// Demo content for Anubhav Advertisers — an offline / out-of-home (OOH)
// advertising company: hoardings, banners, wall media, and transit branding.
// Centralised here so the seed script and any future admin tooling share one
// source of truth.
...
const stats = [
  { label: "Years Running", value: "12", order: 1 },
  { label: "Active Hoarding Sites", value: "340+", order: 2 },
  { label: "Cities Covered", value: "18+", order: 3 },
  { label: "Client Retention", value: "94%", order: 4 },
];
...
module.exports = { services, stats, installations, testimonials, faqs, process };
